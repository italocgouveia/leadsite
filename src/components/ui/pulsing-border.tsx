...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    /**
     * `render` e `requestRender` são function declarations (içadas), e o
     * TypeScript descarta ali dentro o estreitamento de `canvas`/`gl` feito
     * pelos early returns lá em cima. Estes dois aliases devolvem o tipo sem
     * mexer na lógica do shader.
     */
